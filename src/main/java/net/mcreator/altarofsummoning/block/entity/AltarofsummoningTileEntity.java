package net.mcreator.altarofsummoning.block.entity;
...
public class AltarofsummoningTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public AltarofsummoningTileEntity(BlockPos pos, BlockState state) {
		super(AltarOfSummoningModBlockEntities.ALTAROFSUMMONING.get(), pos, state);
	}
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<AltarofsummoningTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<AltarofsummoningTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("altarofsummoning");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Altar of summoning");
	}
